...
parameters = {
    ...
    # Data
    'train_data': '../datasets/train_real_100_aug_0.csv',  # Path to the training iamges directory


    'test_data': '../datasets/real_testing_data.csv',  # Path to the training labels director0
