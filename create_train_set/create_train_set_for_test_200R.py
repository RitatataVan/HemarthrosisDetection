...
# Read augmented data
negatives = glob.glob('/home/qianyu_fan/Qianyu_Code/Qianyu_Dataset/Synthetic_Hemophilia/Negative/*')
positives = glob.glob('/home/qianyu_fan/Qianyu_Code/Qianyu_Dataset/Synthetic_Hemophilia/Positive/*')
syn_neg = [[img_path, 0] for img_path in negatives]
syn_pos = [[img_path, 1] for img_path in positives]
